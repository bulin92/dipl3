...
**На следующем этапе** были созданы **авто-тесты, согласно [Плана автоматизации тестирования](https://github.com/bulin92/dipl3/blob/main/docs/Plan.md)**.

**Тестирование было проведено для двух баз данных - MySQL и PostgreSQL.**

**[Перечень выявленных ошибок](https://github.com/bulin92/dipl3/issues).**
...
![аллюрррр](https://github.com/bulin92/dipl3/assets/130202753/8aaa563b-fe06-4025-9acb-1766f1c3bb2a)
